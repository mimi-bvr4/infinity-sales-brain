...
from config import (
    ...
    HUBSPOT_CLIENT_ID, CALLER_ID_ENABLED,
)
...
# ── Register Caller ID Blueprint (Phase 2) ─────────────────────────
if CALLER_ID_ENABLED:
    from caller_id import caller_id_bp
    app.register_blueprint(caller_id_bp)
...
if __name__ == "__main__":
    ...
    print(f"  Caller ID: {'✅ Enabled' if CALLER_ID_ENABLED else '⏸️  Disabled'}")
